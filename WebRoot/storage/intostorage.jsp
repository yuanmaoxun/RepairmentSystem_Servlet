...
<TABLE width="98%" border=0 align="center">
   <TR>
     	<TD align="right"><FONT color=#493eb5><a href="/RepairmentSystem/storage/addstorage.html" target="work">添加备件信息</a></FONT></TD>
   </TR>
    <TR>
     <TD width="100%">
	<FORM name="intostorage" action="/RepairmentSystem/intostorage" method="post">
