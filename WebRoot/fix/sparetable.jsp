...
<TABLE width="98%" border=0 align="center">
   <TR>
    ...
    <TR>
     <TD width="100%">
	<FORM action="/RepairmentSystem/addspareinfo" method="post">
		  ...
		  <tr height="15" style="height:11.25pt">
			...
			<table border="0" width="100%" >
          	...
          	<TR>
               ...
               <TD width="35%" height=13 colspan="3"><input type = "text" name = "fix_no" value="" size = "30" maxlength="50"/>
			   </TD>
              </TR>
             <TR>
			   ...
			   <TD width="35%" height=13><INPUT type = "text" name="spa_num" value="" size="30" maxlength="50"></TD>
             </TR>
             <TR>
				<TD height=13 colspan="6"  align="center"><INPUT type="submit" value=" 提交  " name=""><INPUT type="reset" value=" 清除  " name=""></TD>
			</TR>
  		  </TABLE>
	</FORM>
	</TD></TR></TABLE>
